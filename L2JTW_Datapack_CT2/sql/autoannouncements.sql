...
(1,900,9000,0,'請玩家遵守官網公告之遊戲管理規章相關內容，並配合GM進行遊戲。'),
(2,1800,9000,0,'突然變成無法移動的狀態時，請先點選畫面左上角自己的名字或血條，再按鍵盤的「Esc」取消目標。'),
(3,2700,9000,0,'掉入地獄或是卡點的的玩家，請輸入「/脫逃」的自救指令 - 需5分鐘。'),
(4,3600,9000,0,'叫喊買賣時，請至交易頻道發言，勿使用一般頻道影響他人。'),
