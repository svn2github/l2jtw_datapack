...
UPDATE `auto_chat_text` SET `chatText` = '聆聽黑暗的啟示吧！黑暗的啟示即將要實現！' WHERE `chatText` = 'The prophecy of darkness has been fulfilled!';
...
**update UPDATE `auto_chat_text` SET `chatText` = '聆聽滅亡的預言吧！末日時代即將要來臨了！' WHERE `chatText` = 'The prophecy of doom has awoken!';
**update UPDATE `auto_chat_text` SET `chatText` = '審判的日子即將來臨！' WHERE `chatText` = 'The day of judgment is near!';
**new UPDATE `auto_chat_text` SET `chatText` = '聆聽黑暗的啟示吧！死亡的樂園即將來臨了！' WHERE `chatText` = 'The prophecy of darkness has been fulfilled!';
