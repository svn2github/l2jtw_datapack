...
UPDATE `weapon` SET `name` ='法國麵包吐司鎚' WHERE item_id ='20258';
UPDATE `weapon` SET `name` ='法國麵包牛角鎚' WHERE item_id ='20259';
UPDATE `weapon` SET `name` ='法國麵包美味槍' WHERE item_id ='20260';
UPDATE `weapon` SET `name` ='法國麵包輕盈弓' WHERE item_id ='20261';
UPDATE `weapon` SET `name` ='法國麵包貝果拳' WHERE item_id ='20262';
UPDATE `weapon` SET `name` ='法國麵包可頌劍' WHERE item_id ='20263';
UPDATE `weapon` SET `name` ='法國麵包香郁杖' WHERE item_id ='20264';
UPDATE `weapon` SET `name` ='法國麵包麻花杖' WHERE item_id ='20265';
UPDATE `weapon` SET `name` ='法國麵包菠蘿盾' WHERE item_id ='20266';
UPDATE `weapon` SET `name` ='法國麵包細刃劍' WHERE item_id ='20267';
