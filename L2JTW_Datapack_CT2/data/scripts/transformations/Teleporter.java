...
public class Teleporter extends L2Transformation
{
	...
	public void removeSkills()
	{
		...
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(5656, 85), false, false);
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(5657, 85), false, false);
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(5658, 85), false, false);
