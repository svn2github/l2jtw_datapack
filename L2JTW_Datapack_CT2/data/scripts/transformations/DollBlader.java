...
public class DollBlader extends L2Transformation
{
	...
	public void transformedSkills()
	{
		...
		this.getPlayer().addSkill(SkillTable.getInstance().getInfo(5491, 1), false);
                // DollBlader Holy Light Burst
		this.getPlayer().addSkill(SkillTable.getInstance().getInfo(752, 3), false);
                // DollBlader Energy Attack
		this.getPlayer().addSkill(SkillTable.getInstance().getInfo(753, 3), false);
                // DollBlader Holy Beam
		this.getPlayer().addSkill(SkillTable.getInstance().getInfo(754, 1), false);
	...
	public void removeSkills()
	{
		...
		this.getPlayer().removeSkill(SkillTable.getInstance().getInfo(5491, 1), false);
                // DollBlader Energy Attack
		this.getPlayer().removeSkill(SkillTable.getInstance().getInfo(752, 3), false);
                // DollBlader Holy Beam
		this.getPlayer().removeSkill(SkillTable.getInstance().getInfo(753, 3), false);
                // DollBlader Sunshine
		this.getPlayer().removeSkill(SkillTable.getInstance().getInfo(754, 1), false);
		// Send a Server->Client packet StatusUpdate to the L2PcInstance.
		this.getPlayer().sendSkillList();
	}
