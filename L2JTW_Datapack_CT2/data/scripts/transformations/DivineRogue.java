...
public class DivineRogue extends L2Transformation
{
	...
	public void removeSkills()
	{
		...
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(686, 1), false, false);
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(687, 1), false, false);
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(688, 1), false, false);
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(689, 1), false, false);
		...
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(797, 1), false, false);
