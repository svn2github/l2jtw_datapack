...
public class AurabirdOwl extends L2Transformation
{
	...
	public void transformedSkills()
	{
		...
		if (getPlayer().getLevel() >= 75)
			...
			getPlayer().addSkill(SkillTable.getInstance().getInfo(895, 1), false);//Update by rocknow
	...
	public void removeSkills()
	{
		...
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(895, 1), false);//Update by rocknow
