...
public class DivineWizard extends L2Transformation
{
	...
	public void removeSkills()
	{
		...
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(692, 1), false, false);
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(693, 1), false, false);
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(694, 1), false, false);
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(695, 1), false, false);
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(696, 1), false, false);
