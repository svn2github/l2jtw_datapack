...
KamalokaLevel    = 26
InstanceTemplate = "Kamaloka_26.xml"
KamaLevels       = [26                          ]
KamaPartySize    = [6                           ]
KamaNPC          = [30332                       ]
KamaTemplate     = ["Kamaloka_26.xml"           ]
KamaMob          = [18555                       ]
KamaMinion       = [18556                       ]
KamaPorts        = [[-82464,-219532,-7899]      ]
...
def runStartRoom(self, world):
	...
	newNpc = self.addSpawn(KamaMob[0], -81891,-220078,-7893, 0, False, 0, False, world.instanceId)
