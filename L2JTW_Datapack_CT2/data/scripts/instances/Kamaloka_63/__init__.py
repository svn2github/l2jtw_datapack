...
KamalokaLevel    = 63
InstanceTemplate = "Kamaloka_63.xml"
KamaLevels       = [63                      ]
KamaPartySize    = [6                       ]
KamaNPC          = [31981                   ]
KamaTemplate     = ["Kamaloka_63.xml"       ]
KamaMob          = [18571                   ]
KamaMinion       = [18572                   ]
KamaPorts        = [[-56940,-212939,-8072]  ]
...
def runStartRoom(self, world):
	...
	newNpc = self.addSpawn(KamaMob[0], -56415,-212939,-8068, 0, False, 0, False, world.instanceId)
