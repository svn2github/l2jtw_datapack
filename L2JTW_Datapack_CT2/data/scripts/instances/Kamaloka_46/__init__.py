...
KamalokaLevel    = 46
InstanceTemplate = "Kamaloka_46.xml"
KamaLevels       = [46                      ]
KamaPartySize    = [6                       ]
KamaNPC          = [30916                   ]
KamaTemplate     = ["Kamaloka_46.xml"       ]
KamaMob          = [18564                   ]
KamaMinion       = [0                       ]
KamaPorts        = [[-81415,-206078,-8107]  ]
...
def runStartRoom(self, world):
	...
	newNpc = self.addSpawn(KamaMob[0], -81937,-206077,-8100, 0, False, 0, False, world.instanceId)
