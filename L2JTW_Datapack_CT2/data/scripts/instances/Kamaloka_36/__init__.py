...
KamalokaLevel    = 36
InstanceTemplate = "Kamaloka_36.xml"
KamaLevels       = [36                      ]
KamaPartySize    = [6                       ]
KamaNPC          = [30071                   ]
KamaTemplate     = ["Kamaloka_36.xml"       ]
KamaMob          = [18559                   ]
KamaMinion       = [18560                   ]
KamaPorts        = [[-81413,-213568,-8104]  ]
...
def runStartRoom(self, world):
	...
	newNpc = self.addSpawn(KamaMob[0], -81937,-213566,-8100, 0, False, 0, False, world.instanceId)
