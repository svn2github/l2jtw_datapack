...
public class Potions implements IItemHandler
{
	...
	/**
	 * 
	 * @see net.sf.l2j.gameserver.handler.IItemHandler#useItem(net.sf.l2j.gameserver.model.actor.instance.L2	Instance, net.sf.l2j.gameserver.model.L2ItemInstance)
	 */
	...
	public boolean usePotion(L2Playable activeChar, int magicId, int level)
	{
		...
		if (skill != null)
		{
			...
			else if (activeChar instanceof L2PetInstance)
			{
				...
				sm.addSkillName(skill);//Update Message by rocknow
