...
event_1 = "<html><body>克洛諾斯：<br>我當然不知道啦~！不，不算是知道...反正啊。我對幼龍...所以說...<br>那個...這樣吧，我覺得去找住在妖精古的<font color=\"LEVEL\">妖精米莫</font>問比較好。當初給你幼龍的也是他呀...對呀對，上次那件事之後，我跟他都互相透過信保持聯繫，可以算是友情嗎？反正我們倆的關係很好。所以說，我會寫信給他，讓他對你和你的幼龍好一點...明白了嗎？你明白我的意思嗎？</body></html>"
error_1 = "<html><body>你需要擁有一頭幼龍，並且將他召喚出來，以完成這個任務。</body></html>"
error_2 = "<html><body>嘿！發生了什麼事？為什麼又有另外一條幼龍？這不是原本的幼龍吧？</body></html>"
error_3 = "<html><body>克洛諾斯：<br>你的等級需求"+str(MIN_PLAYER_LEVEL)+"以上才能解此任務。</body></html>"
error_4 = "<html><body>克洛諾斯：<br>你的寵物等級需求"+str(MIN_PET_LEVEL)+"以上才能解此任務。</body></html>"
error_5 = "你的寵物不是幼龍，任務中斷。"
error_6 = "你的寵物不在身邊，任務中斷。"
qston_1 = "<html><body>克洛諾斯：<br>嘿，你不就是之前吵著要養幼龍的那個人嗎？如何？我跟你說過養幼龍是很難的，所以叫你別養，你卻那麼固執...後悔了吧？！就算是跟牠有緣，把它養成座龍如何？你帶著的小鬼，現在應該長大了吧...？你要不要把那小鬼變成座龍...？<br><a action=\"bypass -h Quest "+str(QUEST_NUMBER)+"_"+QUEST_NAME+" 16\">詢問是否知道其方法</a></body></html>"
qston_2 = "<html><body>克洛諾斯：<br>我已經跟你說去請教<font color=\"LEVEL\">妖精米莫</font>！！說的夠清楚嗎！？</body></html>"
qston_3 = "<html><body>妖精米莫：<br>什麼！你找不到<font color=\"LEVEL\">風、星、黃昏、深淵的妖精木</font>。 別放棄！ 他們全都在<font color=\"LEVEL\">獵人村莊</font>。</body></html>"
order_1 = "<html><body>妖精米莫：<br>你的幼龍必須喝下<font color=\"LEVEL\">風、星、黃昏、深淵的妖精木</font>的汁液來幫助牠的成長。別傷害到願意幫助你的妖精木，拿著這些妖精的葉子，在幼龍喝完樹液之後將它貼在妖精木的傷口上吧。</body></html>"
end_msg = "<html><body>妖精米莫：<br>你的幼龍做的很好。"
