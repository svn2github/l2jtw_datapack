...
-- 修正嗨翻天NPC位置
DELETE FROM `spawnlist` WHERE `npc_templateid` IN (30949,30952,32568,30969,32593,32596);
INSERT INTO `spawnlist` (location,count,npc_templateid,locx,locy,locz,randomx,randomy,heading,respawn_delay,loc_id,periodOfDay) VALUES
...
('Oren Area',1,32568,88084,38422,-3372,0,0,0,60,0,0),                  -- 可疑的屍體
('innadril09_npc2324_07',1,30969,109707,220048,-3520,0,0,7656,60,0,0), -- 艾森海內
('',1,32593,146997,23754,-1996,0,0,65062,60,0,0),                      -- 神官 巫德
('',1,32596,37073,-49867,-1133,0,0,15920,60,0,0);                      -- 賢者圖書館長 索比亞
