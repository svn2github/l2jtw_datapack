 ...
 * @author pmq
 */
public class DragonValleySouth extends Quest
{
	...
	public DragonValleySouth(int questId, String name, String descr)
	{
	...
	{
		new DragonValleySouth(-1, DragonValleySouth.class.getSimpleName(), "teleports");
	}
}
