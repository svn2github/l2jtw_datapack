 ...
 * @author pmq
 */
public class DragonValleyCenter extends Quest
{
	...
	public DragonValleyCenter(int questId, String name, String descr)
	{
	...
	{
		new DragonValleyCenter(-1, DragonValleyCenter.class.getSimpleName(), "teleports");
	}
}
