 ...
 * @author pmq
 */
public class HunterVillage extends Quest
{
	...
	public HunterVillage(int questId, String name, String descr)
	{
	...
	{
		new HunterVillage(-1, HunterVillage.class.getSimpleName(), "teleports");
	}
}
