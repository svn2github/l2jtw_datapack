 ...
 * @author pmq
 */
public class DragonValleyNorth extends Quest
{
	...
	public DragonValleyNorth(int questId, String name, String descr)
	{
	...
	{
		new DragonValleyNorth(-1, DragonValleyNorth.class.getSimpleName(), "teleports");
	}
}
