...
('1', 'cn', '', ' 使用「;」登入「嗨翻天」的服务器，已拒绝。;芙蕾雅;毁灭女神', 'ProtocolVersion.java'),
('2', 'en', '', ' Use ;Newer ;Older ;protocol:;;;', 'ProtocolVersion.java'),
('2', 'tw', '', ' 使用「;更新」的遊戲（協定版本:;）登入伺服器，已;未;最新;拒絕。;允許。', 'ProtocolVersion.java'),
('2', 'cn', '', ' 使用「;更新」的游戏（协定版本:;）登入伺服器，已;未;最新;拒绝。;允许。', 'ProtocolVersion.java'),
...
('44', 'cn', '服务器取消「$E1」，继续正常运作！', '关闭;重新启动;放弃', 'Shutdown.java'),
...
('104', 'cn', '伺服器启动时间：', '', 'RegionBBSManager.java'),
...
('235', 'cn', '你的伴侣已登入。', '', 'EnterWorld.java'),
...
('1226', 'cn', '这个服务器不允许同性结婚！', '', 'Wedding.java'),
...
('1389', 'cn', '警告：此功能已经有几个已知的问题，因此我们「非常不建议」您在正式伺服器上使用这项功能，只建议您使用在开发伺服器。', '', 'AdminAdmin.java'),
...
('1478', 'cn', '」。重新登入后才有效果。', '', 'AdminChangeAccessLevel.java'),
...
('1523', 'cn', '', '玩家「;」与伺服器中断连线。', 'AdminDisconnect.java'),
...
('1910', 'cn', '伺服器尚未启用活力系统。', '', 'AdminVitality.java'),
