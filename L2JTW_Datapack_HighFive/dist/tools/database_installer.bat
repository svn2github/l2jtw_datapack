...
REM 檢查 GS 支援的版本資訊
if not %vgs% == High_Five echo 無法繼續安裝資料庫，因為：
if not %vgs% == High_Five echo GS 支援的版本是：%vgs%
if not %vgs% == High_Five echo DP 支援的版本是：High_Five
if not %vgs% == High_Five echo 請確定 GS 和 DP 都使用相同的版本後，再試一次
