...
public class PcBangPoint extends Quest
{
	...
	/**
	 * 說話之島 Talking Island NPCID 31775, 31776,
	 * 精靈村莊 Elven Village NPCID 31780, 31781,
	 * 黑暗精靈村莊 Dark Elf Village NPCID 31777, 31778, 31779,
	 * 獸人村莊 Orc Village NPCID 31784, 31785, 31786,
	 * 矮人村莊 Dwarven Village NPCID 31782, 31783,
	 * 闇天使村莊 Kamael Village NPCID 32337, 32338, 32339, 32340,
	 * 古魯丁村莊 The Village of Gludin NPCID 31787, 31788, 31789, 31790, 31791,
	 * 古魯丁城鎮 Gludio NPCID 31792, 31793, 31794, 31795, 31796,
	 * 狄恩 Dion NPCID 31797, 31798, 31799, 31800,
	 * 芙蘿蘭村莊 Floran Village NPCID 31801, 31802, 31803,
	 * 水上都市海音斯 Heine NPCID 31819, 31820, 31821, 31822,
	 * 奇岩 Giran NPCID 31804, 31805, 31806, 31807, 31808, 31809,
	 * 哈汀學院 Hardin's Private Academy NPCID 31810,
	 * 歐瑞城鎮 Oren NPCID 31814, 31815, 31816, 31817, 31818,
	 * 象牙塔 Ivory Tower NPCID 31811, 31812, 31813,
	 * 獵人村莊 Hunters Village NPCID 31823, 31824, 31825, 31826,
	 * 亞丁城鎮 Aden NPCID 31827, 31828, 31829, 31830, 31831,
	 * 高達特城鎮 Goddard NPCID 31837, 31838, 31839, 31840, 31841,
	 * 魯因城鎮 Rune NPCID 31832, 31833, 31834, 31835, 31836,
	 * 修加特城鎮 Schuttgart NPCID 31991, 31992, 31993, 31994, 31995,
	 * 修加特城鎮 Schuttgart NPCID 31732=31994, 31733=31991, 31734=31992, 31738=31993, 31729=31995,
	...
	static
	{
		...
		// 說話之島 Talking Island Teleporters
		...
		// 精靈村莊 Elven Village Teleporters
		...
		// 黑暗精靈村莊 Dark Elf Village Teleporters
		...
		// 矮人村莊 Dwarven Village Teleporters
		...
		// 闇天使村莊沒有傳送 Kamael Village No Teleporters
		// 古魯丁村莊 The Village of Gludin Teleporters
		...
		// 芙蘿蘭村莊 Floran Village Teleporters
		...
		// 獵人村莊 Hunters Village Teleporters
		...
		// 哈汀學院 Hardin's Private Academy Teleporters
		TELEPORTERS.put("TELE_86", new int[] { 73024, 118485, -3688, 50 }); // Dragon Valley 50 points = 龍之谷 - 50 點數
		TELEPORTERS.put("TELE_87", new int[] { 131557, 114509, -3712, 80 }); // Antharas Lair 80 points = 安塔瑞斯洞窟 - 80 點數
		TELEPORTERS.put("TELE_88", new int[] { 113553, 134813, -3540, 40 }); // Gorgon Flower Garden 40 points = 哥肯的花園 - 40 點數
		TELEPORTERS.put("TELE_89", new int[] { 60374, 164301, -2856, 140 }); // Tanor Canyon 140 points = 塔諾峽谷 - 140 點數
		// 象牙塔 Ivory Tower Teleporters
		TELEPORTERS.put("TELE_90", new int[] { 106517, -2871, -3416, 90 }); // Ancient Battleground 90 points = 古戰場 - 90 點數
		TELEPORTERS.put("TELE_91", new int[] { 93218, 16969, -3904, 20 }); // Forest of Evil 20 points = 魔道的森林 - 20 點數
		TELEPORTERS.put("TELE_92", new int[] { 67097, 68815, -3648, 120 }); // Timak Outpost 110 points = 提瑪克前哨基地 - 110 點數
	}
