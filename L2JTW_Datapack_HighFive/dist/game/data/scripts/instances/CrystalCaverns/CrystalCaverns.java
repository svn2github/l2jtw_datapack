	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		if (tmpworld instanceof CCWorld)
		{
			...
			else if (event.equalsIgnoreCase("spawn_oracle"))
			{
				...
				//Update by rocknow-Start
				addSpawn((getRandom(10) < 5 ? 29116 : 29117), 153706, 142212, -12741, 7579, false, 300000, false, world.getInstanceId());
				addSpawn((getRandom(10) < 5 ? 29116 : 29117), 154192, 142697, -12741, 7894, false, 300000, false, world.getInstanceId());
				addSpawn((getRandom(10) < 5 ? 29116 : 29117), 153763, 142075, -12741, 64792, false, 300000, false, world.getInstanceId());
				addSpawn((getRandom(10) < 5 ? 29116 : 29117), 153701, 141942, -12741, 57739, false, 300000, false, world.getInstanceId());
				addSpawn((getRandom(10) < 5 ? 29116 : 29117), 153573, 141894, -12741, 49471, false, 300000, false, world.getInstanceId());
				addSpawn((getRandom(10) < 5 ? 29116 : 29117), 153445, 141945, -12741, 41113, false, 300000, false, world.getInstanceId());
				addSpawn((getRandom(10) < 5 ? 29116 : 29117), 153381, 142076, -12741, 32767, false, 300000, false, world.getInstanceId());
				addSpawn((getRandom(10) < 5 ? 29116 : 29117), 153441, 142211, -12741, 25730, false, 300000, false, world.getInstanceId());
				addSpawn((getRandom(10) < 5 ? 29116 : 29117), 153573, 142260, -12741, 16185, false, 300000, false, world.getInstanceId());
				addSpawn((getRandom(10) < 5 ? 29116 : 29117), 153571, 142860, -12741, 16716, false, 300000, false, world.getInstanceId());
				addSpawn((getRandom(10) < 5 ? 29116 : 29117), 152783, 142077, -12741, 32176, false, 300000, false, world.getInstanceId());
				addSpawn((getRandom(10) < 5 ? 29116 : 29117), 153571, 141274, -12741, 49072, false, 300000, false, world.getInstanceId());
				addSpawn((getRandom(10) < 5 ? 29116 : 29117), 154365, 142073, -12741, 64149, false, 300000, false, world.getInstanceId());
				addSpawn((getRandom(10) < 5 ? 29116 : 29117), 152924, 142677, -12741, 25072, false, 300000, false, world.getInstanceId());
				addSpawn((getRandom(10) < 5 ? 29116 : 29117), 152907, 141428, -12741, 39590, false, 300000, false, world.getInstanceId());
				addSpawn((getRandom(10) < 5 ? 29116 : 29117), 154243, 141411, -12741, 55500, false, 300000, false, world.getInstanceId());
				//Update by rocknow-End
			...
			if (event.equalsIgnoreCase("Baylor_TW"))
			{
				...
				L2Npc camera1 = addSpawn(29109,153569,142075,-12732,0,false,0,false,world.getInstanceId());
				this.startQuestTimer("camera_1", 1000, camera1, null);
			}
			else if (event.equalsIgnoreCase("waiting_boss"))
			{
				world._baylor = addSpawn(29099,153569,142075,-12732,60060,false,0,false,world.getInstanceId());
			...
			{
				L2Npc camera2 = addSpawn(29108,153021,142364,-12737,60025,false,0,false,world.getInstanceId());
			...
			else if (event.equalsIgnoreCase("spawn00"))
			{
				if (world._SpawnNum < 12)
				{
					...
					L2Npc mob = addSpawn(29100,153569+x,142075+y,-12732,32300+world._Heading,false,0,false,world.getInstanceId());
			...
			else if (event.equalsIgnoreCase("spawn_minion"))
			{
				for (int i = 0; i < 12; i+=2)
				{
					...
					addSpawn(29100,npc.getX()+x,npc.getY()+y,npc.getZ(),32300+world._Heading,false,0,false,world.getInstanceId());
