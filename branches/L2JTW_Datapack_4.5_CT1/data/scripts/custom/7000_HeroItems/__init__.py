...
6612:["weapon_the_two_handed_sword_of_hero_i00","無限滅斬","致命攻擊時追加額外傷害。賦予裝備者機率性反射詛咒、提升HP/CP最大值、提升致命攻擊率與致命攻擊威力的功能。提升PvP傷害。","461/169","雙手劍"],
6613:["weapon_the_axe_of_hero_i00","無限霸斧","致命攻擊時使目標陷入混亂。賦予裝備者還擊、提升HP/MP/CP最大值、提升盾牌防禦機率的功能。提升PvP傷害。","379/169","單手鈍器"],
6614:["weapon_the_mace_of_hero_i00","無限神杖","施展良性魔法時機率性完全恢復目標的HP。賦予裝備者提升MP/CP最大值、施法速度、MP自然恢復力的功能。提升PvP傷害。","303/226","單手法杖"],
6615:["weapon_the_hammer_of_hero_i00","無限巨鎚","致命攻擊時使目標陷入休克。賦予裝備者機率性反射詛咒、提升HP/CP最大值、攻擊速度的功能。提升PvP傷害。","461/169","雙手鈍器"],
6616:["weapon_the_staff_of_hero_i00","無限魔杖","施展良性魔法時機率性完全恢復目標的HP。賦予裝備者提升MP/CP最大值、魔法攻擊力、MP消耗量下降、提升魔法致命攻擊率、降低施法被中斷機率的功能。提升PvP傷害。","369/226","雙手法杖"],
...
6618:["weapon_the_fist_of_hero_i00","無限殛牙","致命攻擊時使目標陷入休克。賦予裝備者機率性反射詛咒、提升HP/MP/CP最大值、迴避能力的功能。提升PvP傷害。","461/169","拳套"],
6619:["weapon_the_bow_of_hero_i00","無限斷空","致命攻擊時使目標陷入移動速度下降的狀態。賦予裝備者節射、快速恢復、提升MP最大值的功能。提升PvP傷害。","707/169","弓"],
6620:["weapon_the_dualsword_of_hero_i00","無限鬥翼","致命攻擊時封印目標的物理技能。賦予裝備者機率性反射詛咒、提升HP/MP/CP最大值、致命攻擊率的功能。提升PvP傷害。","461/169","雙刀"],
6621:["weapon_the_pole_of_hero_i00","無限烈槍","致命攻擊時消除目標輔助狀態。賦予裝備者機率性反射詛咒、提升HP最大值、攻擊速度、命中能力的功能。提升PvP傷害。","379/169","槍"],
9388:["weapon_infinity_rapier_i00","無限瞬閃","致命攻擊時可向對方施展物理防禦力降低的詛咒魔法，並提升還擊護盾、提升MAX HP/MAX MP/Max CP。PvP時提升所造成的傷害。\n強化4以上的話，致命攻擊時將會以一定的機率提升自己和隊伍成員們的物理攻擊力、魔法攻擊力和所受的治癒量，並發揮使用技能時降低MP消耗量的效果。","344/169","細劍"],
9389:["weapon_infinity_sword_i00","無限岩裂","致命攻擊時追加額外傷害。賦予裝備者機率性反射技能、提升HP/CP最大值、提升致命攻擊率與致命攻擊威力的功能。PvP時提升所造成的傷害。","410/169","古代劍"],
9390:["weapon_infinity_shooter_i00","無限追魂","致命攻擊時可向對方施展緩速魔法，使用技能時降低MP消耗量、提升MAX MP/Max CP。PvP時提升所造成的傷害。","405/169","弩"],
       ...
       if event == "buy" :
          ...
          if item == 6842:
            if st.getQuestItemsCount(6842):
             ...
             st.giveItems(item,1)
             htmltext = "享用你的"+HERO_ITEMS[item][1]+"吧。"
