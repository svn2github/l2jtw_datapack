...
KamalokaLevel    = 69
InstanceTemplate = "Kamaloka_69.xml"
KamaLevels       = [69                       ]
KamaPartySize    = [9                        ]
KamaNPC          = [31981                    ]
KamaTemplate     = ["Kamaloka_69.xml"        ]
KamaMob          = [22497,22498,22499        ]
KamaMinion       = [29142,29143              ]
KamaBoss         = [29141                    ]
KamaBoss1        = [25620                    ]
...
class Quest (JQuest) :
	...
	def onAttack(self,npc,player,damage,isPet,skill):
		...
		if self.worlds.has_key(npc.getInstanceId()):
			...
			if world.status == 0:
				if npc.getNpcId() in [22497,22498,22499,25620,29141,29142,29143]:
...
for mob in [22497,22498,22499,25620,29141,29142,29143]:
