...
public class PailakaInjuredDragon extends Quest
{
	...
	// NPCS
	private static final int KETRA_ORC_SHAMAN              = 32499;  // �֯S���~�H �G�N�h
	private static final int KETRA_ORC_SUPPORTER           = 32502;  // �֯S���~�H��U��
	private static final int KETRA_ORC_SUPPORTER2          = 32512;  // �֯S���~�H�ᴩ��
	private static final int KETRA_ORC_INTELIGENCE_OFFICER = 32509;  // �֯S���~�H�ҳ��
	
	// WALL MOBS
	private static final int VARKA_SILENOS_RECRUIT     = 18635;  // �ڷ�d�ɰǿմ��V�m�L
	private static final int VARKA_SILENOS_FOOTMAN     = 18636;  // �ڷ�d�ɰǿմ��B�L
	private static final int VARKA_SILENOS_WARRIOR     = 18642;  // �ڷ�d�ɰǿմ��Ԥh
	private static final int VARKA_SILENOS_OFFICER     = 18646;  // �ڷ�d�ɰǿմ��U�h
	private static final int VARKAS_COMMANDER          = 18654;  // �ڷ�d�x�Ϊ�
	private static final int VARKA_ELITE_GUARD         = 18653;  // �ڷ�d��U�˽ö�
	private static final int VARKA_SILENOS_GREAT_MAGUS = 18649;  // �ڷ�d�ɰǿմ��j�]�ɤh
	private static final int VARKA_SILENOS_GENERAL     = 18650;  // �ڷ�d�ɰǿմ��x�x
	private static final int VARKA_SILENOS_HEAD_GUARD  = 18655;  // �ڷ�d���u�˽ö�
	private static final int PROPHET_GUARD             = 18657;  // �w���̪��˽çL
	private static final int VARKAS_PROPHET            = 18659;  // �ڷ�d�w����
	
	// EXTRA WALL SILENOS
	private static final int VARKA_SILENOS_MEDIUM      = 18644;  // �ڷ�d�ɰǿմ��F�C
	private static final int VARKA_SILENOS_PRIEST      = 18641;  // �ڷ�d�ɰǿմ����q
	private static final int VARKA_SILENOS_SHAMAN      = 18640;  // �ڷ�d�ɰǿմ��G�N�h
	private static final int VARKA_SILENOS_SEER        = 18648;  // �ڷ�d�ɰǿմ����q��
	private static final int VARKA_SILENOS_MAGNUS      = 18645;  // �ڷ�d�ɰǿմ��]�ɤh
	private static final int DISCIPLE_OF_PROPHET       = 18658;  // �w���̪���{
	private static final int VARKA_HEAD_MAGUS          = 18656;  // �ڷ�d���u�]�ɤh
	private static final int VARKA_SILENOS_GREAT_SEER  = 18652;  // �ڷ�d�ɰǿմ��j���q��
	
	// NORMAL MOBS
	private static final int ANTYLOPE_1                = 18637;  // �񪪪��ܦ�
	private static final int ANTYLOPE_2                = 18643;  // �񪪪��ܦ�
	private static final int ANTYLOPE_3                = 18651;  // �񪪪��ܦϪ��
	private static final int FLAVA                     = 18647;  // �񪪪��ܩԥ�
	
	// BOSS
	private static final int LATANA = 18660;  // �Զ�
	
	// ITEMS
	private static final int SPEAR     = 13052;  // �ɰǿմ����j
	private static final int ENCHSPEAR = 13053;  // �j���ɰǿմ����j
	private static final int LASTSPEAR = 13054;  // �������ɰǿմ����j
	private static final int STAGE1    = 13056;  // �Z���ɯ� ���q1
	private static final int STAGE2    = 13057;  // �Z���ɯ� ���q2
	
	private static final int SHIELD_POTION = 13032;  // ��ԥd�Y�ɬ�
	private static final int HEAL_POTION   = 13033;  // ������O�v¡�Ĥ�
	
	// Rewards
	private static final int PSHIRT = 13296;  // ��ԥd�m
	private static final int SCROLL_OF_ESCAPE = 736;  // ��^���b
	
	private static final String EMPTY = "<html><body>�ثe�S��������ȡA�α�󤣲šC</body></html>";
	...
	{
		new PailakaInjuredDragon(144, qn, "��ԥd-��˪��s");
	}
}