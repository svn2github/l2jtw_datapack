...
('436', 'en', 'You crystallizing too fast.', '', 'UseItem.java'),
('436', 'tw', '你結晶化的速度太快。', '', 'UseItem.java'),
('436', 'cn', '你结晶化的速度太快。', '', 'UseItem.java'),
('437', 'en', 'Cannot use this item.', '', 'UseItem.java'),
('437', 'tw', '不能使用該物品。', '', 'UseItem.java'),
('437', 'cn', '不能使用该物品。', '', 'UseItem.java'),
