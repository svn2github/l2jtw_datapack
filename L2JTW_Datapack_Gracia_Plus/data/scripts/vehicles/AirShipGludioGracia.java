		...
		try
		{
			switch (_cycle)
			{
				case 0:
					...
					{
						_atc.dockShip(null);
						_atc.broadcastMessage("開往格勒西亞大陸的定期飛空艇已出發。");
					}
				...
				case 3:
					...
					{
						_atc.dockShip(_ship);
						_atc.broadcastMessage("定期飛空艇已經抵達。1分鐘後，將會開往亞丁大陸。");
					}
				...
				case 4:
					...
					{
						_atc.dockShip(null);
						_atc.broadcastMessage("開往亞丁大陸的定期飛空艇已出發");
					}
				...
				case 7:
					...
					{
						_atc.dockShip(_ship);
						_atc.broadcastMessage("定期飛空艇已經抵達。1分鐘後，將會開往格勒西亞大陸。");
					}
