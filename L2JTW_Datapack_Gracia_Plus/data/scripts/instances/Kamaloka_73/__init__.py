...
KamalokaLevel    = 73
InstanceTemplate = "Kamaloka_73.xml"
KamaLevels       = [73                      ]
KamaPartySize    = [6                       ]
KamaNPC          = [31340                   ]
KamaTemplate     = ["Kamaloka_73.xml"       ]
KamaMob          = [18577                   ]
KamaMinion       = [18578                   ]
KamaPorts        = [[-49805,-206139,-8117]  ]
...
def runStartRoom(self, world):
	...
	newNpc = self.addSpawn(KamaMob[0], -49084,-206140,-8115, 0, False, 0, False, world.instanceId)
