...
KamalokaLevel    = 53
InstanceTemplate = "Kamaloka_53.xml"
KamaLevels       = [53                      ]
KamaPartySize    = [6                       ]
KamaNPC          = [30196                   ]
KamaTemplate     = ["Kamaloka_53.xml"       ]
KamaMob          = [18566                   ]
KamaMinion       = [18567                   ]
KamaPorts        = [[-56999,-219856,-8117]  ]
...
def runStartRoom(self, world):
	...
	newNpc = self.addSpawn(KamaMob[0], -56281,-219859,-8115, 0, False, 0, False, world.instanceId)
