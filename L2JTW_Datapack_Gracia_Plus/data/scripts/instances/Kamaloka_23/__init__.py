...
KamalokaLevel    = 23
InstanceTemplate = "Kamaloka_23.xml"
KamaLevels       = [23                         ]
KamaPartySize    = [6                          ]
KamaNPC          = [30332                      ]
KamaTemplate     = ["Kamaloka_23.xml"          ]
KamaMob          = [18554                      ]
KamaMinion       = [0                          ]
KamaPorts        = [[-88429,-220629,-7903]     ]
...
def runStartRoom(self, world):
	...
	newNpc = self.addSpawn(KamaMob[0], -88998,-220077,-7892, 0, False, 0, False, world.instanceId)
