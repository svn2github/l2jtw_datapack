   ...
   if id == State.COMPLETED:
     ...
     if fwear :
       ...
       if npcId == 31520 and cond == 1 :
         ...
         htmltext = "30838-5a.htm"  #pmq增加對話
       elif npcId == 30164 and cond == 5 :
         htmltext = "30164-1a.htm"  #pmq增加對話
