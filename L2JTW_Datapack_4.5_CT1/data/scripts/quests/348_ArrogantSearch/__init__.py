...
ARKS={
HOLY_ARK_OF_SECRECY_1: [FIRST_KEY_OF_ARK,ANGEL_KILLER,"30977-01.htm","30977-02.htm","30977-03.htm",BLOOD_OF_SAINT],
...
class Quest (JQuest) :
 ...
 def onAttack (self, npc, player, damage, isPet):
     ...
     if npcId in ATTACK_DROPS_24.keys() :
         ...
         if st.getInt("cond") == cond and st.getRandom(100) < ATTACK_DROPS_24[npcId][3] and st.getQuestItemsCount(ATTACK_DROPS_24[npcId][4]) > 0 :  # Attack drops are low chance
         ...
         if st.getInt("cond") == cond and st.getRandom(100) < ATTACK_DROPS_25[npcId][3] and st.getQuestItemsCount(ATTACK_DROPS_25[npcId][4]) > 0 :  # Attack drops are low chance
